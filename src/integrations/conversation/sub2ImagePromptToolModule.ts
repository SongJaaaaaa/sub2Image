import { createPromptStudioTool, imageDomain, type PromptStudioToolBundle } from '../../features/promptStudio'
...
export function createSub2ImagePromptStudio(): PromptStudioToolBundle {
