        ...
        <div className="safe-area-x safe-header-inner max-w-7xl mx-auto flex items-center justify-between relative">
          <div className="flex-1 min-w-0 pr-2 flex items-center gap-2">
            {showFavoriteCollectionTitle && (
              <h1 className="inline-flex min-w-0 items-start relative mr-2 sm:hidden">
                <span className="min-w-0 truncate text-[17px] font-bold tracking-tight text-gray-800 dark:text-gray-100" title={favoriteCollectionTitle}>
